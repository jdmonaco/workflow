...
- 📦 **Context Aggregation:** Powerful context management using glob patterns, explicit file lists, or workflow outputs. Supports text files, PDFs, and images (via Vision API), giving Claude comprehensive project awareness.
